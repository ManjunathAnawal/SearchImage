...
class PhotoManager {
    ...
    static func searchImages(from searchQuery: String, completionHandler: @escaping (PhotoSearchResponse) -> Void) {
        let requestURL = getURL(from: searchQuery)
    ...
    private static func getURL(from searchQuery: String) -> URLComponents {
